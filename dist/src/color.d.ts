 ...
 */
import type { RGB, RGBA, HSL, HSLA } from '../types/index.ts';
/**
 ...
 */
export declare const hsl: (h: number, s: number, l: number) => HSL;
/**
 ...
 */
export declare const hslToRgb: (color: HSL) => RGB;
/**
 ...
 */
export declare const colorLerp: (a: RGB, b: RGB, t: number) => RGB;
/**
 ...
 */
export declare const colorLerpHsl: (a: HSL, b: HSL, t: number) => HSL;
/**
 ...
 */
export declare const brighten: (color: RGB, amount: number) => RGB;
/**
 ...
 * @see {@link saturate} and {@link desaturate} for saturation control
 */
export declare const darken: (color: RGB, amount: number) => RGB;
/**
 ...
 */
export declare const saturate: (color: RGB, amount: number) => RGB;
/**
 ...
 * @see {@link grayscale} for complete desaturation
 */
export declare const desaturate: (color: RGB, amount: number) => RGB;
/**
 ...
 */
export declare const hueShift: (color: RGB, degrees: number) => RGB;
/**
 ...
 */
export declare const grayscale: (color: RGB) => RGB;
/**
 ...
 */
export declare const invert: (color: RGB) => RGB;
/**
 ...
 */
export declare const contrast: (color: RGB, amount: number) => RGB;
/**
 ...
 */
export declare const complementary: (color: RGB) => RGB;
/**
 ...
 */
export declare const triadic: (color: RGB) => [RGB, RGB];
/**
 ...
 */
export declare const analogous: (color: RGB, angle?: number) => [RGB, RGB];
export declare const splitComplementary: (color: RGB) => [RGB, RGB];
export declare const tetradic: (color: RGB) => [RGB, RGB, RGB];
/**
 ...
 */
export declare const colorDistance: (a: RGB, b: RGB) => number;
/**
 ...
 */
export declare const colorSimilarity: (a: RGB, b: RGB) => number;
export declare const colors: {
    ...
    readonly yellow: RGB;
    readonly cyan: RGB;
    readonly magenta: RGB;
    readonly gray: RGB;
    readonly lightGray: RGB;
    readonly darkGray: RGB;
    readonly orange: RGB;
    readonly purple: RGB;
    readonly pink: RGB;
    readonly brown: RGB;
...
export declare const toCssRgb: (color: RGB) => string;
export declare const toCssRgba: (color: RGBA) => string;
export declare const toCssHsl: (color: HSL) => string;
export declare const toCssHsla: (color: HSLA) => string;
