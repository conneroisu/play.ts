 ...
 */
export declare const smootherstep: (edge0: number, edge1: number, x: number) => number;
/**
 ...
 */
export declare const vec2Add: (a: Vector2, b: Vector2) => Vector2;
/**
 ...
 */
export declare const vec2Sub: (a: Vector2, b: Vector2) => Vector2;
/**
 ...
 */
export declare const vec2Mul: (a: Vector2, scalar: number) => Vector2;
/**
 ...
 * @see {@link vec2Length} for magnitude calculation
 */
export declare const vec2Div: (a: Vector2, scalar: number) => Vector2;
/**
 ...
 * @see {@link vec2Normalize} for unit vectors
 */
export declare const vec2Dot: (a: Vector2, b: Vector2) => number;
export declare const vec2Length: (v: Vector2) => number;
export declare const vec2LengthSq: (v: Vector2) => number;
export declare const vec2Normalize: (v: Vector2) => Vector2;
export declare const vec2Distance: (a: Vector2, b: Vector2) => number;
export declare const vec2Angle: (v: Vector2) => number;
export declare const vec2FromAngle: (angle: number, length?: number) => Vector2;
export declare const vec2Lerp: (a: Vector2, b: Vector2, t: number) => Vector2;
export declare const vec2Rotate: (v: Vector2, angle: number) => Vector2;
export declare const vec3: (x: number, y: number, z: number) => Vector3;
export declare const vec3Add: (a: Vector3, b: Vector3) => Vector3;
export declare const vec3Sub: (a: Vector3, b: Vector3) => Vector3;
export declare const vec3Mul: (a: Vector3, scalar: number) => Vector3;
export declare const vec3Div: (a: Vector3, scalar: number) => Vector3;
export declare const vec3Dot: (a: Vector3, b: Vector3) => number;
export declare const vec3Cross: (a: Vector3, b: Vector3) => Vector3;
export declare const vec3Length: (v: Vector3) => number;
export declare const vec3LengthSq: (v: Vector3) => number;
export declare const vec3Normalize: (v: Vector3) => Vector3;
export declare const vec3Distance: (a: Vector3, b: Vector3) => number;
export declare const vec3Lerp: (a: Vector3, b: Vector3, t: number) => Vector3;
export declare const mat3Identity: () => Matrix3x3;
export declare const mat3FromValues: (m00: number, m01: number, m02: number, m10: number, m11: number, m12: number, m20: number, m21: number, m22: number) => Matrix3x3;
export declare const mat3Multiply: (a: Matrix3x3, b: Matrix3x3) => Matrix3x3;
export declare const mat3TransformVec2: (m: Matrix3x3, v: Vector2) => Vector2;
