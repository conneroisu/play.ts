...
export default function AsciiServerRoomMonitoringExample() {
			...
			<div className="flex-shrink-0 bg-gray-900 p-4 border-b border-gray-700">
				...
				<div className="mt-4 pt-4 border-t border-gray-700">
					<a
						...
						className="inline-flex items-center px-4 py-2 text-sm font-medium text-blue-300 bg-gray-800 border border-gray-600 rounded-md hover:bg-gray-700 hover:text-blue-200 transition-colors"
					>
