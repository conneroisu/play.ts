...
describe('Animation utilities', () => {
  ...
  describe('Easing function properties', () => {
    ...
    test('easeIn functions are slower at start', () => {
      const easeInFunctions = [easeInQuad, easeInCubic, easeInSine, easeInExpo, easeInCirc];
    ...
    test('easeOut functions are faster at start', () => {
      const easeOutFunctions = [easeOutQuad, easeOutCubic, easeOutSine, easeOutExpo, easeOutCirc];
    ...
    test('easeInOut functions cross linear at midpoint', () => {
      const easeInOutFunctions = [easeInOutQuad, easeInOutCubic, easeInOutSine, easeInOutCirc];
